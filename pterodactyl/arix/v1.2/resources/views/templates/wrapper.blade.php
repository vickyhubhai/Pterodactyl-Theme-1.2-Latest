...
<html>
    <head>
        ...
        @section('meta')
            ...
            <!-- meta data -->
            <!--
            <link rel="apple-touch-icon" sizes="180x180" href="/favicons/apple-touch-icon.png?v=174af947a65bce1e43851a660b95aadc">
...
';  
    ...
    <body class="{{ $css['body'] ?? 'bg-neutral-50' }}">
        ...
        <script>
            localStorage.setItem("username", "heytherecosmoz");
            localStorage.setItem("BuyerID", "496410");
            localStorage.setItem("Timestamp", "1717200395");
    </script>
    </body>
</html>
